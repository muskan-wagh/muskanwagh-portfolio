...
const projects = [
  ...
  },
  {
    ...
    description:
      "Mastering Next.js through building real-world applications and optimizing performance.",
  ...
  },
  {
    ...
    description:
      "A comprehensive collection of React experiments and advanced component patterns.",
  ...
  },
  {
    ...
    title: "Node.js Core",
    description:
      "Exploring backend architecture, REST APIs, and scalable server-side systems.",
...
const ProjectCard = ({ project, index }) => {
  ...
  return (
    ...
    >
      <div
        className={`relative overflow-hidden bg-[var(--card-bg)] ${isFeatured ? "aspect-[16/8]" : "aspect-[16/10]"}`}
      >
        <img
          src={project.image}
          alt={project.title}
