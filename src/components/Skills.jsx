...
import { FaReact, FaJs, FaGithub, FaDocker } from "react-icons/fa";
import {
  SiTailwindcss,
  SiCplusplus,
  SiNodedotjs,
...
const skills = [
  ...
  { name: "CI/CD", icon: <SiCircleci />, color: "currentColor" },
        ...
        >
          {skills.map((skill, i) => (
            ...
            >
              ...
              <span
                className="text-[11px] uppercase tracking-[0.2em] text-[var(--text-secondary)] leading-tight"
